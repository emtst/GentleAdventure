...
\titlegraphic{%
  \begin{picture}(100,0)
    {
      \put(0,22){\includegraphics[width=3cm]{figures/imperial_logo.pdf}}
      % \put(260,10){\includegraphics[width=2.5cm]{figures/Uok_Logo_RGB294.jpg}}
      \put(90,10){\includegraphics[width=2.5cm]{figures/Uok_Logo.jpg}}
      \put(180,15){\includegraphics[width=2.5cm]{figures/logo-large-london.jpg}}
    }
  \end{picture}
  }

\title{A Gentle Adventure Mechanising Message Passing Concurrency Systems}
\subtitle{{\normalsize \color{cyan} An Experience/Walkthrough Report}}
%\author{}
\author{{\scriptsize David Castro-Perez, Lorenzo Gheri, Francisco Ferreira, Nobuko Yoshida, and Martin Vassor} \\ \begin{center}\textbf{DisCoTec22}\end{center}}
\date{}
% \date{%\put(0,-60){
%   17-05-2021
% %}
...
\usepackage[export]{adjustbox} % inclduegraphics with frame
\usepackage{fancybox}
