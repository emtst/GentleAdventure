...
\title{A Gentle Adventure Exploring the Mechanisation of Binary Session Types}
\subtitle{smol-EMTST: Binary Session Types, the essential parts.}
\author{David Castro-Perez, \textbf{Francisco Ferreira}, Lorenzo Gheri, and Nobuko Yoshida}
\institute{}
\date{}
% \date{%\put(0,-60){
%   17-05-2021
