...
\titlegraphic{%
  \begin{picture}(382,0)
    {
      \put(120,22){\includegraphics[width=3cm]{imperial_logo.pdf}}
      \put(200,10){\includegraphics[width=2.5cm]{Uok_Logo_RGB294.jpg}}
      \put(280,10){\includegraphics[width=3cm]{logo-large-london.jpg}}
    }
  \end{picture}
  }
...
\author{\footnotesize David Castro-Perez, Francisco Ferreira, \textbf{Lorenzo Gheri}, Martin Vassor, and Nobuko Yoshida}
\institute{}
\date{\footnotesize DisCoTec, 13-06-2022}
% \date{%\put(0,-60){
%   17-05-2021
% %}
% }
...
\begin{frame}{You Suffer, but Why?}
...
%% \end{footnotesize}
  ...
  \begin{columns}
    \begin{column}{0.6\textwidth}
      \begin{center}
        \vspace{-5mm}
        \includegraphics[width=0.8\textwidth]{benchmark.jpeg}
      \end{center}
    \end{column}
    \begin{column}{0.4\textwidth}
      ...
      \\ \ \\
      \visible<2>{
        \textcolor{violet}{And... \bf{THANK YOU!}}
      }
    \end{column}
  \end{columns}
